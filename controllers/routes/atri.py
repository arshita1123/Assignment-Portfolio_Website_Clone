...
class Atri:
	def __init__(self, state: Any):
		...
		self.OuterMostFlex2 = state["OuterMostFlex2"]
		self.InnerFlex2 = state["InnerFlex2"]
		self.AboutContentFlex = state["AboutContentFlex"]
		self.AboutContent = state["AboutContent"]
		self.About6 = state["About6"]
		self.Flex14 = state["Flex14"]
		self.About1 = state["About1"]
		self.MyImageFlex = state["MyImageFlex"]
		self.OuterMostFlex3 = state["OuterMostFlex3"]
		self.InnerFlex3 = state["InnerFlex3"]
		self.Flex18 = state["Flex18"]
		self.OuterMostFlex1 = state["OuterMostFlex1"]
		self.InnerFlex1 = state["InnerFlex1"]
		self.MainLogoFlex = state["MainLogoFlex"]
		self.NavigationFlex = state["NavigationFlex"]
		self.SubNavigation = state["SubNavigation"]
		self.OuterMostFlex4 = state["OuterMostFlex4"]
		self.InnerFlex4 = state["InnerFlex4"]
		self.ServiceFlex1 = state["ServiceFlex1"]
		self.ServiceFlex2 = state["ServiceFlex2"]
		self.Service2 = state["Service2"]
		self.Service3 = state["Service3"]
		self.Service = state["Service"]
		self.OuterMostFlex5 = state["OuterMostFlex5"]
		self.InnerFlex5 = state["InnerFlex5"]
		self.ProjectFlex = state["ProjectFlex"]
		self.ProjectFlex2 = state["ProjectFlex2"]
		self.Project1 = state["Project1"]
		self.ProjectImage1 = state["ProjectImage1"]
		self.ProjectInfo1 = state["ProjectInfo1"]
		self.Project3 = state["Project3"]
		self.ProjectInfo3 = state["ProjectInfo3"]
		self.ProjectImage3 = state["ProjectImage3"]
		self.Project4 = state["Project4"]
		self.ProjectImage4 = state["ProjectImage4"]
		self.ProjectInfo4 = state["ProjectInfo4"]
		self.Project2 = state["Project2"]
		self.ProjectImage2 = state["ProjectImage2"]
		self.ProjectInfo2 = state["ProjectInfo2"]
		self.ProjectFlex1 = state["ProjectFlex1"]
		self.Flex85 = state["Flex85"]
		self.Flex86 = state["Flex86"]
		self.OuterMostFlex7 = state["OuterMostFlex7"]
		self.InnerFlex7 = state["InnerFlex7"]
		self.ContentFlex = state["ContentFlex"]
		self.LeftFlex = state["LeftFlex"]
		self.RightFlex = state["RightFlex"]
		self.ImageFlex = state["ImageFlex"]
		self.Image3 = state["Image3"]
		self.Image1 = state["Image1"]
		self.Image2 = state["Image2"]
		self.OuterMostFlex6 = state["OuterMostFlex6"]
		self.InnerFlex6 = state["InnerFlex6"]
		self.BlogFlex1 = state["BlogFlex1"]
		self.BlogFlex2 = state["BlogFlex2"]
		self.RightBlogs = state["RightBlogs"]
		self.Blog5 = state["Blog5"]
		self.Flex129 = state["Flex129"]
		self.Flex124 = state["Flex124"]
		self.Blog4 = state["Blog4"]
		self.Flex130 = state["Flex130"]
		self.Flex125 = state["Flex125"]
		self.Blog3 = state["Blog3"]
		self.Flex131 = state["Flex131"]
		self.Flex126 = state["Flex126"]
		self.Blog2 = state["Blog2"]
		self.Flex132 = state["Flex132"]
		self.Flex127 = state["Flex127"]
		self.Blog1 = state["Blog1"]
		self.Flex133 = state["Flex133"]
		self.Flex128 = state["Flex128"]
		self.LeftBlogs = state["LeftBlogs"]
		self.OuterMostFlex8 = state["OuterMostFlex8"]
		self.InnerFlex8 = state["InnerFlex8"]
		self.EducationFlex = state["EducationFlex"]
		self.Institute = state["Institute"]
		self.Institute3 = state["Institute3"]
		self.Flex169 = state["Flex169"]
		self.Flex170 = state["Flex170"]
		self.Institute2 = state["Institute2"]
		self.Flex171 = state["Flex171"]
		self.Flex172 = state["Flex172"]
		self.Institute1 = state["Institute1"]
		self.Flex173 = state["Flex173"]
		self.Flex174 = state["Flex174"]
		self.Education = state["Education"]
		self.Flex178 = state["Flex178"]
		self.WorkExperianceFlex = state["WorkExperianceFlex"]
		self.WorkExperience = state["WorkExperience"]
		self.Flex159 = state["Flex159"]
		self.Domain = state["Domain"]
		self.Domain1 = state["Domain1"]
		self.Flex160 = state["Flex160"]
		self.Flex162 = state["Flex162"]
		self.Domain2 = state["Domain2"]
		self.Flex163 = state["Flex163"]
		self.Flex164 = state["Flex164"]
		self.Domain3 = state["Domain3"]
		self.Flex166 = state["Flex166"]
		self.Flex167 = state["Flex167"]
		self.OuterMostFlex9 = state["OuterMostFlex9"]
		self.InnerFlex9 = state["InnerFlex9"]
		self.LeftContent = state["LeftContent"]
		self.content3 = state["content3"]
		self.Content1 = state["Content1"]
		self.content2 = state["content2"]
		self.RightContent = state["RightContent"]
		self.InvertedComma = state["InvertedComma"]
		self.Info = state["Info"]
		self.Person = state["Person"]
		self.OuterMostFlex10 = state["OuterMostFlex10"]
		self.InnerFlex10 = state["InnerFlex10"]
		self.FAQFlex = state["FAQFlex"]
		self.QuestionFlex = state["QuestionFlex"]
		self.LeftQuestions = state["LeftQuestions"]
		self.Question1 = state["Question1"]
		self.Question2 = state["Question2"]
		self.Question4 = state["Question4"]
		self.Question3 = state["Question3"]
		self.RightQuestions = state["RightQuestions"]
		self.Question8 = state["Question8"]
		self.Question7 = state["Question7"]
		self.Question6 = state["Question6"]
		self.Question5 = state["Question5"]
		self.AddressFlex = state["AddressFlex"]
		self.ContentFlex2 = state["ContentFlex2"]
		self.Address = state["Address"]
		self.Address1 = state["Address1"]
		self.Flex244 = state["Flex244"]
		self.Address2 = state["Address2"]
		self.Column1 = state["Column1"]
		self.Column2 = state["Column2"]
		self.Column3 = state["Column3"]
		self.FooterFlex = state["FooterFlex"]
		self.About3 = state["About3"]
		self.About2 = state["About2"]
		self.About4 = state["About4"]
		self.About5 = state["About5"]
		...
		self.ProfileImage = state["ProfileImage"]
		...
		self.BlogNav = state["BlogNav"]
		self.AboutNav = state["AboutNav"]
		self.ServiceNav = state["ServiceNav"]
		self.ProjectNav = state["ProjectNav"]
		self.BookCallNav = state["BookCallNav"]
	...
	@property
	def OuterMostFlex2(self):
		self._getter_access_tracker["OuterMostFlex2"] = {}
		return self._OuterMostFlex2
	@OuterMostFlex2.setter
	def OuterMostFlex2(self, new_state):
		self._setter_access_tracker["OuterMostFlex2"] = {}
		global default_state
		self._OuterMostFlex2 = Flex(new_state, default_state["OuterMostFlex2"])

	@property
	def InnerFlex2(self):
		self._getter_access_tracker["InnerFlex2"] = {}
		return self._InnerFlex2
	@InnerFlex2.setter
	def InnerFlex2(self, new_state):
		self._setter_access_tracker["InnerFlex2"] = {}
		global default_state
		self._InnerFlex2 = Flex(new_state, default_state["InnerFlex2"])

	@property
	def AboutContentFlex(self):
		self._getter_access_tracker["AboutContentFlex"] = {}
		return self._AboutContentFlex
	@AboutContentFlex.setter
	def AboutContentFlex(self, new_state):
		self._setter_access_tracker["AboutContentFlex"] = {}
		global default_state
		self._AboutContentFlex = Flex(new_state, default_state["AboutContentFlex"])

	@property
	def AboutContent(self):
		self._getter_access_tracker["AboutContent"] = {}
		return self._AboutContent
	@AboutContent.setter
	def AboutContent(self, new_state):
		self._setter_access_tracker["AboutContent"] = {}
		global default_state
		self._AboutContent = Flex(new_state, default_state["AboutContent"])

	@property
	def About6(self):
		self._getter_access_tracker["About6"] = {}
		return self._About6
	@About6.setter
	def About6(self, new_state):
		self._setter_access_tracker["About6"] = {}
		global default_state
		self._About6 = Flex(new_state, default_state["About6"])
	...
	@property
	def About1(self):
		self._getter_access_tracker["About1"] = {}
		return self._About1
	@About1.setter
	def About1(self, new_state):
		self._setter_access_tracker["About1"] = {}
		global default_state
		self._About1 = Flex(new_state, default_state["About1"])

	@property
	def MyImageFlex(self):
		self._getter_access_tracker["MyImageFlex"] = {}
		return self._MyImageFlex
	@MyImageFlex.setter
	def MyImageFlex(self, new_state):
		self._setter_access_tracker["MyImageFlex"] = {}
		global default_state
		self._MyImageFlex = Flex(new_state, default_state["MyImageFlex"])

	@property
	def OuterMostFlex3(self):
		self._getter_access_tracker["OuterMostFlex3"] = {}
		return self._OuterMostFlex3
	@OuterMostFlex3.setter
	def OuterMostFlex3(self, new_state):
		self._setter_access_tracker["OuterMostFlex3"] = {}
		global default_state
		self._OuterMostFlex3 = Flex(new_state, default_state["OuterMostFlex3"])

	@property
	def InnerFlex3(self):
		self._getter_access_tracker["InnerFlex3"] = {}
		return self._InnerFlex3
	@InnerFlex3.setter
	def InnerFlex3(self, new_state):
		self._setter_access_tracker["InnerFlex3"] = {}
		global default_state
		self._InnerFlex3 = Flex(new_state, default_state["InnerFlex3"])
	...
	@property
	def OuterMostFlex1(self):
		self._getter_access_tracker["OuterMostFlex1"] = {}
		return self._OuterMostFlex1
	@OuterMostFlex1.setter
	def OuterMostFlex1(self, new_state):
		self._setter_access_tracker["OuterMostFlex1"] = {}
		global default_state
		self._OuterMostFlex1 = Flex(new_state, default_state["OuterMostFlex1"])

	@property
	def InnerFlex1(self):
		self._getter_access_tracker["InnerFlex1"] = {}
		return self._InnerFlex1
	@InnerFlex1.setter
	def InnerFlex1(self, new_state):
		self._setter_access_tracker["InnerFlex1"] = {}
		global default_state
		self._InnerFlex1 = Flex(new_state, default_state["InnerFlex1"])

	@property
	def MainLogoFlex(self):
		self._getter_access_tracker["MainLogoFlex"] = {}
		return self._MainLogoFlex
	@MainLogoFlex.setter
	def MainLogoFlex(self, new_state):
		self._setter_access_tracker["MainLogoFlex"] = {}
		global default_state
		self._MainLogoFlex = Flex(new_state, default_state["MainLogoFlex"])
	...
	@property
	def SubNavigation(self):
		self._getter_access_tracker["SubNavigation"] = {}
		return self._SubNavigation
	@SubNavigation.setter
	def SubNavigation(self, new_state):
		self._setter_access_tracker["SubNavigation"] = {}
		global default_state
		self._SubNavigation = Flex(new_state, default_state["SubNavigation"])

	@property
	def OuterMostFlex4(self):
		self._getter_access_tracker["OuterMostFlex4"] = {}
		return self._OuterMostFlex4
	@OuterMostFlex4.setter
	def OuterMostFlex4(self, new_state):
		self._setter_access_tracker["OuterMostFlex4"] = {}
		global default_state
		self._OuterMostFlex4 = Flex(new_state, default_state["OuterMostFlex4"])

	@property
	def InnerFlex4(self):
		self._getter_access_tracker["InnerFlex4"] = {}
		return self._InnerFlex4
	@InnerFlex4.setter
	def InnerFlex4(self, new_state):
		self._setter_access_tracker["InnerFlex4"] = {}
		global default_state
		self._InnerFlex4 = Flex(new_state, default_state["InnerFlex4"])

	@property
	def ServiceFlex1(self):
		self._getter_access_tracker["ServiceFlex1"] = {}
		return self._ServiceFlex1
	@ServiceFlex1.setter
	def ServiceFlex1(self, new_state):
		self._setter_access_tracker["ServiceFlex1"] = {}
		global default_state
		self._ServiceFlex1 = Flex(new_state, default_state["ServiceFlex1"])

	@property
	def ServiceFlex2(self):
		self._getter_access_tracker["ServiceFlex2"] = {}
		return self._ServiceFlex2
	@ServiceFlex2.setter
	def ServiceFlex2(self, new_state):
		self._setter_access_tracker["ServiceFlex2"] = {}
		global default_state
		self._ServiceFlex2 = Flex(new_state, default_state["ServiceFlex2"])
	...
	def Service2(self, new_state):
		...
		global default_state
		self._Service2 = Flex(new_state, default_state["Service2"])
	...
	def Service3(self, new_state):
		...
		global default_state
		self._Service3 = Flex(new_state, default_state["Service3"])
	...
	def Service(self, new_state):
		...
		global default_state
		self._Service = Flex(new_state, default_state["Service"])

	@property
	def OuterMostFlex5(self):
		self._getter_access_tracker["OuterMostFlex5"] = {}
		return self._OuterMostFlex5
	@OuterMostFlex5.setter
	def OuterMostFlex5(self, new_state):
		self._setter_access_tracker["OuterMostFlex5"] = {}
		global default_state
		self._OuterMostFlex5 = Flex(new_state, default_state["OuterMostFlex5"])

	@property
	def InnerFlex5(self):
		self._getter_access_tracker["InnerFlex5"] = {}
		return self._InnerFlex5
	@InnerFlex5.setter
	def InnerFlex5(self, new_state):
		self._setter_access_tracker["InnerFlex5"] = {}
		global default_state
		self._InnerFlex5 = Flex(new_state, default_state["InnerFlex5"])

	@property
	def ProjectFlex(self):
		self._getter_access_tracker["ProjectFlex"] = {}
		return self._ProjectFlex
	@ProjectFlex.setter
	def ProjectFlex(self, new_state):
		self._setter_access_tracker["ProjectFlex"] = {}
		global default_state
		self._ProjectFlex = Flex(new_state, default_state["ProjectFlex"])

	@property
	def ProjectFlex2(self):
		self._getter_access_tracker["ProjectFlex2"] = {}
		return self._ProjectFlex2
	@ProjectFlex2.setter
	def ProjectFlex2(self, new_state):
		self._setter_access_tracker["ProjectFlex2"] = {}
		global default_state
		self._ProjectFlex2 = Flex(new_state, default_state["ProjectFlex2"])
	...
	def Project1(self, new_state):
		...
		global default_state
		self._Project1 = Flex(new_state, default_state["Project1"])

	@property
	def ProjectImage1(self):
		self._getter_access_tracker["ProjectImage1"] = {}
		return self._ProjectImage1
	@ProjectImage1.setter
	def ProjectImage1(self, new_state):
		self._setter_access_tracker["ProjectImage1"] = {}
		global default_state
		self._ProjectImage1 = Flex(new_state, default_state["ProjectImage1"])

	@property
	def ProjectInfo1(self):
		self._getter_access_tracker["ProjectInfo1"] = {}
		return self._ProjectInfo1
	@ProjectInfo1.setter
	def ProjectInfo1(self, new_state):
		self._setter_access_tracker["ProjectInfo1"] = {}
		global default_state
		self._ProjectInfo1 = Flex(new_state, default_state["ProjectInfo1"])

	@property
	def Project3(self):
		self._getter_access_tracker["Project3"] = {}
		return self._Project3
	@Project3.setter
	def Project3(self, new_state):
		self._setter_access_tracker["Project3"] = {}
		global default_state
		self._Project3 = Flex(new_state, default_state["Project3"])

	@property
	def ProjectInfo3(self):
		self._getter_access_tracker["ProjectInfo3"] = {}
		return self._ProjectInfo3
	@ProjectInfo3.setter
	def ProjectInfo3(self, new_state):
		self._setter_access_tracker["ProjectInfo3"] = {}
		global default_state
		self._ProjectInfo3 = Flex(new_state, default_state["ProjectInfo3"])

	@property
	def ProjectImage3(self):
		self._getter_access_tracker["ProjectImage3"] = {}
		return self._ProjectImage3
	@ProjectImage3.setter
	def ProjectImage3(self, new_state):
		self._setter_access_tracker["ProjectImage3"] = {}
		global default_state
		self._ProjectImage3 = Flex(new_state, default_state["ProjectImage3"])

	@property
	def Project4(self):
		self._getter_access_tracker["Project4"] = {}
		return self._Project4
	@Project4.setter
	def Project4(self, new_state):
		self._setter_access_tracker["Project4"] = {}
		global default_state
		self._Project4 = Flex(new_state, default_state["Project4"])

	@property
	def ProjectImage4(self):
		self._getter_access_tracker["ProjectImage4"] = {}
		return self._ProjectImage4
	@ProjectImage4.setter
	def ProjectImage4(self, new_state):
		self._setter_access_tracker["ProjectImage4"] = {}
		global default_state
		self._ProjectImage4 = Flex(new_state, default_state["ProjectImage4"])

	@property
	def ProjectInfo4(self):
		self._getter_access_tracker["ProjectInfo4"] = {}
		return self._ProjectInfo4
	@ProjectInfo4.setter
	def ProjectInfo4(self, new_state):
		self._setter_access_tracker["ProjectInfo4"] = {}
		global default_state
		self._ProjectInfo4 = Flex(new_state, default_state["ProjectInfo4"])

	@property
	def Project2(self):
		self._getter_access_tracker["Project2"] = {}
		return self._Project2
	@Project2.setter
	def Project2(self, new_state):
		self._setter_access_tracker["Project2"] = {}
		global default_state
		self._Project2 = Flex(new_state, default_state["Project2"])

	@property
	def ProjectImage2(self):
		self._getter_access_tracker["ProjectImage2"] = {}
		return self._ProjectImage2
	@ProjectImage2.setter
	def ProjectImage2(self, new_state):
		self._setter_access_tracker["ProjectImage2"] = {}
		global default_state
		self._ProjectImage2 = Flex(new_state, default_state["ProjectImage2"])

	@property
	def ProjectInfo2(self):
		self._getter_access_tracker["ProjectInfo2"] = {}
		return self._ProjectInfo2
	@ProjectInfo2.setter
	def ProjectInfo2(self, new_state):
		self._setter_access_tracker["ProjectInfo2"] = {}
		global default_state
		self._ProjectInfo2 = Flex(new_state, default_state["ProjectInfo2"])

	@property
	def ProjectFlex1(self):
		self._getter_access_tracker["ProjectFlex1"] = {}
		return self._ProjectFlex1
	@ProjectFlex1.setter
	def ProjectFlex1(self, new_state):
		self._setter_access_tracker["ProjectFlex1"] = {}
		global default_state
		self._ProjectFlex1 = Flex(new_state, default_state["ProjectFlex1"])
	...
	@property
	def OuterMostFlex7(self):
		self._getter_access_tracker["OuterMostFlex7"] = {}
		return self._OuterMostFlex7
	@OuterMostFlex7.setter
	def OuterMostFlex7(self, new_state):
		self._setter_access_tracker["OuterMostFlex7"] = {}
		global default_state
		self._OuterMostFlex7 = Flex(new_state, default_state["OuterMostFlex7"])

	@property
	def InnerFlex7(self):
		self._getter_access_tracker["InnerFlex7"] = {}
		return self._InnerFlex7
	@InnerFlex7.setter
	def InnerFlex7(self, new_state):
		self._setter_access_tracker["InnerFlex7"] = {}
		global default_state
		self._InnerFlex7 = Flex(new_state, default_state["InnerFlex7"])

	@property
	def ContentFlex(self):
		self._getter_access_tracker["ContentFlex"] = {}
		return self._ContentFlex
	@ContentFlex.setter
	def ContentFlex(self, new_state):
		self._setter_access_tracker["ContentFlex"] = {}
		global default_state
		self._ContentFlex = Flex(new_state, default_state["ContentFlex"])

	@property
	def LeftFlex(self):
		self._getter_access_tracker["LeftFlex"] = {}
		return self._LeftFlex
	@LeftFlex.setter
	def LeftFlex(self, new_state):
		self._setter_access_tracker["LeftFlex"] = {}
		global default_state
		self._LeftFlex = Flex(new_state, default_state["LeftFlex"])

	@property
	def RightFlex(self):
		self._getter_access_tracker["RightFlex"] = {}
		return self._RightFlex
	@RightFlex.setter
	def RightFlex(self, new_state):
		self._setter_access_tracker["RightFlex"] = {}
		global default_state
		self._RightFlex = Flex(new_state, default_state["RightFlex"])

	@property
	def ImageFlex(self):
		self._getter_access_tracker["ImageFlex"] = {}
		return self._ImageFlex
	@ImageFlex.setter
	def ImageFlex(self, new_state):
		self._setter_access_tracker["ImageFlex"] = {}
		global default_state
		self._ImageFlex = Flex(new_state, default_state["ImageFlex"])
	...
	def Image3(self, new_state):
		...
		global default_state
		self._Image3 = Flex(new_state, default_state["Image3"])
	...
	def Image1(self, new_state):
		...
		global default_state
		self._Image1 = Flex(new_state, default_state["Image1"])
	...
	def Image2(self, new_state):
		...
		global default_state
		self._Image2 = Flex(new_state, default_state["Image2"])

	@property
	def OuterMostFlex6(self):
		self._getter_access_tracker["OuterMostFlex6"] = {}
		return self._OuterMostFlex6
	@OuterMostFlex6.setter
	def OuterMostFlex6(self, new_state):
		self._setter_access_tracker["OuterMostFlex6"] = {}
		global default_state
		self._OuterMostFlex6 = Flex(new_state, default_state["OuterMostFlex6"])

	@property
	def InnerFlex6(self):
		self._getter_access_tracker["InnerFlex6"] = {}
		return self._InnerFlex6
	@InnerFlex6.setter
	def InnerFlex6(self, new_state):
		self._setter_access_tracker["InnerFlex6"] = {}
		global default_state
		self._InnerFlex6 = Flex(new_state, default_state["InnerFlex6"])

	@property
	def BlogFlex1(self):
		self._getter_access_tracker["BlogFlex1"] = {}
		return self._BlogFlex1
	@BlogFlex1.setter
	def BlogFlex1(self, new_state):
		self._setter_access_tracker["BlogFlex1"] = {}
		global default_state
		self._BlogFlex1 = Flex(new_state, default_state["BlogFlex1"])

	@property
	def BlogFlex2(self):
		self._getter_access_tracker["BlogFlex2"] = {}
		return self._BlogFlex2
	@BlogFlex2.setter
	def BlogFlex2(self, new_state):
		self._setter_access_tracker["BlogFlex2"] = {}
		global default_state
		self._BlogFlex2 = Flex(new_state, default_state["BlogFlex2"])

	@property
	def RightBlogs(self):
		self._getter_access_tracker["RightBlogs"] = {}
		return self._RightBlogs
	@RightBlogs.setter
	def RightBlogs(self, new_state):
		self._setter_access_tracker["RightBlogs"] = {}
		global default_state
		self._RightBlogs = Flex(new_state, default_state["RightBlogs"])

	@property
	def Blog5(self):
		self._getter_access_tracker["Blog5"] = {}
		return self._Blog5
	@Blog5.setter
	def Blog5(self, new_state):
		self._setter_access_tracker["Blog5"] = {}
		global default_state
		self._Blog5 = Flex(new_state, default_state["Blog5"])
	...
	@property
	def Blog4(self):
		self._getter_access_tracker["Blog4"] = {}
		return self._Blog4
	@Blog4.setter
	def Blog4(self, new_state):
		self._setter_access_tracker["Blog4"] = {}
		global default_state
		self._Blog4 = Flex(new_state, default_state["Blog4"])
	...
	@property
	def Blog3(self):
		self._getter_access_tracker["Blog3"] = {}
		return self._Blog3
	@Blog3.setter
	def Blog3(self, new_state):
		self._setter_access_tracker["Blog3"] = {}
		global default_state
		self._Blog3 = Flex(new_state, default_state["Blog3"])
	...
	@property
	def Blog2(self):
		self._getter_access_tracker["Blog2"] = {}
		return self._Blog2
	@Blog2.setter
	def Blog2(self, new_state):
		self._setter_access_tracker["Blog2"] = {}
		global default_state
		self._Blog2 = Flex(new_state, default_state["Blog2"])
	...
	@property
	def Blog1(self):
		self._getter_access_tracker["Blog1"] = {}
		return self._Blog1
	@Blog1.setter
	def Blog1(self, new_state):
		self._setter_access_tracker["Blog1"] = {}
		global default_state
		self._Blog1 = Flex(new_state, default_state["Blog1"])
	...
	@property
	def LeftBlogs(self):
		self._getter_access_tracker["LeftBlogs"] = {}
		return self._LeftBlogs
	@LeftBlogs.setter
	def LeftBlogs(self, new_state):
		self._setter_access_tracker["LeftBlogs"] = {}
		global default_state
		self._LeftBlogs = Flex(new_state, default_state["LeftBlogs"])

	@property
	def OuterMostFlex8(self):
		self._getter_access_tracker["OuterMostFlex8"] = {}
		return self._OuterMostFlex8
	@OuterMostFlex8.setter
	def OuterMostFlex8(self, new_state):
		self._setter_access_tracker["OuterMostFlex8"] = {}
		global default_state
		self._OuterMostFlex8 = Flex(new_state, default_state["OuterMostFlex8"])

	@property
	def InnerFlex8(self):
		self._getter_access_tracker["InnerFlex8"] = {}
		return self._InnerFlex8
	@InnerFlex8.setter
	def InnerFlex8(self, new_state):
		self._setter_access_tracker["InnerFlex8"] = {}
		global default_state
		self._InnerFlex8 = Flex(new_state, default_state["InnerFlex8"])

	@property
	def EducationFlex(self):
		self._getter_access_tracker["EducationFlex"] = {}
		return self._EducationFlex
	@EducationFlex.setter
	def EducationFlex(self, new_state):
		self._setter_access_tracker["EducationFlex"] = {}
		global default_state
		self._EducationFlex = Flex(new_state, default_state["EducationFlex"])

	@property
	def Institute(self):
		self._getter_access_tracker["Institute"] = {}
		return self._Institute
	@Institute.setter
	def Institute(self, new_state):
		self._setter_access_tracker["Institute"] = {}
		global default_state
		self._Institute = Flex(new_state, default_state["Institute"])

	@property
	def Institute3(self):
		self._getter_access_tracker["Institute3"] = {}
		return self._Institute3
	@Institute3.setter
	def Institute3(self, new_state):
		self._setter_access_tracker["Institute3"] = {}
		global default_state
		self._Institute3 = Flex(new_state, default_state["Institute3"])
	...
	@property
	def Institute2(self):
		self._getter_access_tracker["Institute2"] = {}
		return self._Institute2
	@Institute2.setter
	def Institute2(self, new_state):
		self._setter_access_tracker["Institute2"] = {}
		global default_state
		self._Institute2 = Flex(new_state, default_state["Institute2"])
	...
	@property
	def Institute1(self):
		self._getter_access_tracker["Institute1"] = {}
		return self._Institute1
	@Institute1.setter
	def Institute1(self, new_state):
		self._setter_access_tracker["Institute1"] = {}
		global default_state
		self._Institute1 = Flex(new_state, default_state["Institute1"])
	...
	@property
	def WorkExperianceFlex(self):
		self._getter_access_tracker["WorkExperianceFlex"] = {}
		return self._WorkExperianceFlex
	@WorkExperianceFlex.setter
	def WorkExperianceFlex(self, new_state):
		self._setter_access_tracker["WorkExperianceFlex"] = {}
		global default_state
		self._WorkExperianceFlex = Flex(new_state, default_state["WorkExperianceFlex"])
	...
	@property
	def Domain(self):
		self._getter_access_tracker["Domain"] = {}
		return self._Domain
	@Domain.setter
	def Domain(self, new_state):
		self._setter_access_tracker["Domain"] = {}
		global default_state
		self._Domain = Flex(new_state, default_state["Domain"])

	@property
	def Domain1(self):
		self._getter_access_tracker["Domain1"] = {}
		return self._Domain1
	@Domain1.setter
	def Domain1(self, new_state):
		self._setter_access_tracker["Domain1"] = {}
		global default_state
		self._Domain1 = Flex(new_state, default_state["Domain1"])
	...
	@property
	def Domain2(self):
		self._getter_access_tracker["Domain2"] = {}
		return self._Domain2
	@Domain2.setter
	def Domain2(self, new_state):
		self._setter_access_tracker["Domain2"] = {}
		global default_state
		self._Domain2 = Flex(new_state, default_state["Domain2"])
	...
	@property
	def Domain3(self):
		self._getter_access_tracker["Domain3"] = {}
		return self._Domain3
	@Domain3.setter
	def Domain3(self, new_state):
		self._setter_access_tracker["Domain3"] = {}
		global default_state
		self._Domain3 = Flex(new_state, default_state["Domain3"])
	...
	@property
	def OuterMostFlex9(self):
		self._getter_access_tracker["OuterMostFlex9"] = {}
		return self._OuterMostFlex9
	@OuterMostFlex9.setter
	def OuterMostFlex9(self, new_state):
		self._setter_access_tracker["OuterMostFlex9"] = {}
		global default_state
		self._OuterMostFlex9 = Flex(new_state, default_state["OuterMostFlex9"])

	@property
	def InnerFlex9(self):
		self._getter_access_tracker["InnerFlex9"] = {}
		return self._InnerFlex9
	@InnerFlex9.setter
	def InnerFlex9(self, new_state):
		self._setter_access_tracker["InnerFlex9"] = {}
		global default_state
		self._InnerFlex9 = Flex(new_state, default_state["InnerFlex9"])

	@property
	def LeftContent(self):
		self._getter_access_tracker["LeftContent"] = {}
		return self._LeftContent
	@LeftContent.setter
	def LeftContent(self, new_state):
		self._setter_access_tracker["LeftContent"] = {}
		global default_state
		self._LeftContent = Flex(new_state, default_state["LeftContent"])

	@property
	def content3(self):
		self._getter_access_tracker["content3"] = {}
		return self._content3
	@content3.setter
	def content3(self, new_state):
		self._setter_access_tracker["content3"] = {}
		global default_state
		self._content3 = Flex(new_state, default_state["content3"])

	@property
	def Content1(self):
		self._getter_access_tracker["Content1"] = {}
		return self._Content1
	@Content1.setter
	def Content1(self, new_state):
		self._setter_access_tracker["Content1"] = {}
		global default_state
		self._Content1 = Flex(new_state, default_state["Content1"])

	@property
	def content2(self):
		self._getter_access_tracker["content2"] = {}
		return self._content2
	@content2.setter
	def content2(self, new_state):
		self._setter_access_tracker["content2"] = {}
		global default_state
		self._content2 = Flex(new_state, default_state["content2"])

	@property
	def RightContent(self):
		self._getter_access_tracker["RightContent"] = {}
		return self._RightContent
	@RightContent.setter
	def RightContent(self, new_state):
		self._setter_access_tracker["RightContent"] = {}
		global default_state
		self._RightContent = Flex(new_state, default_state["RightContent"])

	@property
	def InvertedComma(self):
		self._getter_access_tracker["InvertedComma"] = {}
		return self._InvertedComma
	@InvertedComma.setter
	def InvertedComma(self, new_state):
		self._setter_access_tracker["InvertedComma"] = {}
		global default_state
		self._InvertedComma = Flex(new_state, default_state["InvertedComma"])

	@property
	def Info(self):
		self._getter_access_tracker["Info"] = {}
		return self._Info
	@Info.setter
	def Info(self, new_state):
		self._setter_access_tracker["Info"] = {}
		global default_state
		self._Info = Flex(new_state, default_state["Info"])

	@property
	def Person(self):
		self._getter_access_tracker["Person"] = {}
		return self._Person
	@Person.setter
	def Person(self, new_state):
		self._setter_access_tracker["Person"] = {}
		global default_state
		self._Person = Flex(new_state, default_state["Person"])

	@property
	def OuterMostFlex10(self):
		self._getter_access_tracker["OuterMostFlex10"] = {}
		return self._OuterMostFlex10
	@OuterMostFlex10.setter
	def OuterMostFlex10(self, new_state):
		self._setter_access_tracker["OuterMostFlex10"] = {}
		global default_state
		self._OuterMostFlex10 = Flex(new_state, default_state["OuterMostFlex10"])

	@property
	def InnerFlex10(self):
		self._getter_access_tracker["InnerFlex10"] = {}
		return self._InnerFlex10
	@InnerFlex10.setter
	def InnerFlex10(self, new_state):
		self._setter_access_tracker["InnerFlex10"] = {}
		global default_state
		self._InnerFlex10 = Flex(new_state, default_state["InnerFlex10"])

	@property
	def FAQFlex(self):
		self._getter_access_tracker["FAQFlex"] = {}
		return self._FAQFlex
	@FAQFlex.setter
	def FAQFlex(self, new_state):
		self._setter_access_tracker["FAQFlex"] = {}
		global default_state
		self._FAQFlex = Flex(new_state, default_state["FAQFlex"])

	@property
	def QuestionFlex(self):
		self._getter_access_tracker["QuestionFlex"] = {}
		return self._QuestionFlex
	@QuestionFlex.setter
	def QuestionFlex(self, new_state):
		self._setter_access_tracker["QuestionFlex"] = {}
		global default_state
		self._QuestionFlex = Flex(new_state, default_state["QuestionFlex"])

	@property
	def LeftQuestions(self):
		self._getter_access_tracker["LeftQuestions"] = {}
		return self._LeftQuestions
	@LeftQuestions.setter
	def LeftQuestions(self, new_state):
		self._setter_access_tracker["LeftQuestions"] = {}
		global default_state
		self._LeftQuestions = Flex(new_state, default_state["LeftQuestions"])

	@property
	def Question1(self):
		self._getter_access_tracker["Question1"] = {}
		return self._Question1
	@Question1.setter
	def Question1(self, new_state):
		self._setter_access_tracker["Question1"] = {}
		global default_state
		self._Question1 = Flex(new_state, default_state["Question1"])

	@property
	def Question2(self):
		self._getter_access_tracker["Question2"] = {}
		return self._Question2
	@Question2.setter
	def Question2(self, new_state):
		self._setter_access_tracker["Question2"] = {}
		global default_state
		self._Question2 = Flex(new_state, default_state["Question2"])

	@property
	def Question4(self):
		self._getter_access_tracker["Question4"] = {}
		return self._Question4
	@Question4.setter
	def Question4(self, new_state):
		self._setter_access_tracker["Question4"] = {}
		global default_state
		self._Question4 = Flex(new_state, default_state["Question4"])

	@property
	def Question3(self):
		self._getter_access_tracker["Question3"] = {}
		return self._Question3
	@Question3.setter
	def Question3(self, new_state):
		self._setter_access_tracker["Question3"] = {}
		global default_state
		self._Question3 = Flex(new_state, default_state["Question3"])

	@property
	def RightQuestions(self):
		self._getter_access_tracker["RightQuestions"] = {}
		return self._RightQuestions
	@RightQuestions.setter
	def RightQuestions(self, new_state):
		self._setter_access_tracker["RightQuestions"] = {}
		global default_state
		self._RightQuestions = Flex(new_state, default_state["RightQuestions"])

	@property
	def Question8(self):
		self._getter_access_tracker["Question8"] = {}
		return self._Question8
	@Question8.setter
	def Question8(self, new_state):
		self._setter_access_tracker["Question8"] = {}
		global default_state
		self._Question8 = Flex(new_state, default_state["Question8"])

	@property
	def Question7(self):
		self._getter_access_tracker["Question7"] = {}
		return self._Question7
	@Question7.setter
	def Question7(self, new_state):
		self._setter_access_tracker["Question7"] = {}
		global default_state
		self._Question7 = Flex(new_state, default_state["Question7"])

	@property
	def Question6(self):
		self._getter_access_tracker["Question6"] = {}
		return self._Question6
	@Question6.setter
	def Question6(self, new_state):
		self._setter_access_tracker["Question6"] = {}
		global default_state
		self._Question6 = Flex(new_state, default_state["Question6"])

	@property
	def Question5(self):
		self._getter_access_tracker["Question5"] = {}
		return self._Question5
	@Question5.setter
	def Question5(self, new_state):
		self._setter_access_tracker["Question5"] = {}
		global default_state
		self._Question5 = Flex(new_state, default_state["Question5"])

	@property
	def AddressFlex(self):
		self._getter_access_tracker["AddressFlex"] = {}
		return self._AddressFlex
	@AddressFlex.setter
	def AddressFlex(self, new_state):
		self._setter_access_tracker["AddressFlex"] = {}
		global default_state
		self._AddressFlex = Flex(new_state, default_state["AddressFlex"])

	@property
	def ContentFlex2(self):
		self._getter_access_tracker["ContentFlex2"] = {}
		return self._ContentFlex2
	@ContentFlex2.setter
	def ContentFlex2(self, new_state):
		self._setter_access_tracker["ContentFlex2"] = {}
		global default_state
		self._ContentFlex2 = Flex(new_state, default_state["ContentFlex2"])
	...
	@property
	def Address1(self):
		self._getter_access_tracker["Address1"] = {}
		return self._Address1
	@Address1.setter
	def Address1(self, new_state):
		self._setter_access_tracker["Address1"] = {}
		global default_state
		self._Address1 = Flex(new_state, default_state["Address1"])
	...
	@property
	def Address2(self):
		self._getter_access_tracker["Address2"] = {}
		return self._Address2
	@Address2.setter
	def Address2(self, new_state):
		self._setter_access_tracker["Address2"] = {}
		global default_state
		self._Address2 = Flex(new_state, default_state["Address2"])

	@property
	def Column1(self):
		self._getter_access_tracker["Column1"] = {}
		return self._Column1
	@Column1.setter
	def Column1(self, new_state):
		self._setter_access_tracker["Column1"] = {}
		global default_state
		self._Column1 = Flex(new_state, default_state["Column1"])

	@property
	def Column2(self):
		self._getter_access_tracker["Column2"] = {}
		return self._Column2
	@Column2.setter
	def Column2(self, new_state):
		self._setter_access_tracker["Column2"] = {}
		global default_state
		self._Column2 = Flex(new_state, default_state["Column2"])

	@property
	def Column3(self):
		self._getter_access_tracker["Column3"] = {}
		return self._Column3
	@Column3.setter
	def Column3(self, new_state):
		self._setter_access_tracker["Column3"] = {}
		global default_state
		self._Column3 = Flex(new_state, default_state["Column3"])

	@property
	def FooterFlex(self):
		self._getter_access_tracker["FooterFlex"] = {}
		return self._FooterFlex
	@FooterFlex.setter
	def FooterFlex(self, new_state):
		self._setter_access_tracker["FooterFlex"] = {}
		global default_state
		self._FooterFlex = Flex(new_state, default_state["FooterFlex"])

	@property
	def About3(self):
		self._getter_access_tracker["About3"] = {}
		return self._About3
	@About3.setter
	def About3(self, new_state):
		self._setter_access_tracker["About3"] = {}
		global default_state
		self._About3 = TextBox(new_state, default_state["About3"])

	@property
	def About2(self):
		self._getter_access_tracker["About2"] = {}
		return self._About2
	@About2.setter
	def About2(self, new_state):
		self._setter_access_tracker["About2"] = {}
		global default_state
		self._About2 = TextBox(new_state, default_state["About2"])

	@property
	def About4(self):
		self._getter_access_tracker["About4"] = {}
		return self._About4
	@About4.setter
	def About4(self, new_state):
		self._setter_access_tracker["About4"] = {}
		global default_state
		self._About4 = TextBox(new_state, default_state["About4"])

	@property
	def About5(self):
		self._getter_access_tracker["About5"] = {}
		return self._About5
	@About5.setter
	def About5(self, new_state):
		self._setter_access_tracker["About5"] = {}
		global default_state
		self._About5 = TextBox(new_state, default_state["About5"])
	...
	def ProfileImage(self):
		self._getter_access_tracker["ProfileImage"] = {}
		return self._ProfileImage
	@ProfileImage.setter
	def ProfileImage(self, new_state):
		self._setter_access_tracker["ProfileImage"] = {}
		global default_state
		self._ProfileImage = Image(new_state, default_state["ProfileImage"])
	...
	def TrustedBy(self, new_state):
		...
		global default_state
		self._TrustedBy = TextBox(new_state, default_state["TrustedBy"])
	...
	@property
	def BlogNav(self):
		self._getter_access_tracker["BlogNav"] = {}
		return self._BlogNav
	@BlogNav.setter
	def BlogNav(self, new_state):
		self._setter_access_tracker["BlogNav"] = {}
		global default_state
		self._BlogNav = TextBox(new_state, default_state["BlogNav"])

	@property
	def AboutNav(self):
		self._getter_access_tracker["AboutNav"] = {}
		return self._AboutNav
	@AboutNav.setter
	def AboutNav(self, new_state):
		self._setter_access_tracker["AboutNav"] = {}
		global default_state
		self._AboutNav = TextBox(new_state, default_state["AboutNav"])

	@property
	def ServiceNav(self):
		self._getter_access_tracker["ServiceNav"] = {}
		return self._ServiceNav
	@ServiceNav.setter
	def ServiceNav(self, new_state):
		self._setter_access_tracker["ServiceNav"] = {}
		global default_state
		self._ServiceNav = TextBox(new_state, default_state["ServiceNav"])

	@property
	def ProjectNav(self):
		self._getter_access_tracker["ProjectNav"] = {}
		return self._ProjectNav
	@ProjectNav.setter
	def ProjectNav(self, new_state):
		self._setter_access_tracker["ProjectNav"] = {}
		global default_state
		self._ProjectNav = TextBox(new_state, default_state["ProjectNav"])

	@property
	def BookCallNav(self):
		self._getter_access_tracker["BookCallNav"] = {}
		return self._BookCallNav
	@BookCallNav.setter
	def BookCallNav(self, new_state):
		self._setter_access_tracker["BookCallNav"] = {}
		global default_state
		self._BookCallNav = TextBox(new_state, default_state["BookCallNav"])
	...
	def _to_json_fields(self):
		return {
			"OuterMostFlex2": self._OuterMostFlex2,
			"InnerFlex2": self._InnerFlex2,
			"AboutContentFlex": self._AboutContentFlex,
			"AboutContent": self._AboutContent,
			"About6": self._About6,
			"Flex14": self._Flex14,
			"About1": self._About1,
			"MyImageFlex": self._MyImageFlex,
			"OuterMostFlex3": self._OuterMostFlex3,
			"InnerFlex3": self._InnerFlex3,
			"Flex18": self._Flex18,
			"OuterMostFlex1": self._OuterMostFlex1,
			"InnerFlex1": self._InnerFlex1,
			"MainLogoFlex": self._MainLogoFlex,
			"NavigationFlex": self._NavigationFlex,
			"SubNavigation": self._SubNavigation,
			"OuterMostFlex4": self._OuterMostFlex4,
			"InnerFlex4": self._InnerFlex4,
			"ServiceFlex1": self._ServiceFlex1,
			"ServiceFlex2": self._ServiceFlex2,
			"Service2": self._Service2,
			"Service3": self._Service3,
			"Service": self._Service,
			"OuterMostFlex5": self._OuterMostFlex5,
			"InnerFlex5": self._InnerFlex5,
			"ProjectFlex": self._ProjectFlex,
			"ProjectFlex2": self._ProjectFlex2,
			"Project1": self._Project1,
			"ProjectImage1": self._ProjectImage1,
			"ProjectInfo1": self._ProjectInfo1,
			"Project3": self._Project3,
			"ProjectInfo3": self._ProjectInfo3,
			"ProjectImage3": self._ProjectImage3,
			"Project4": self._Project4,
			"ProjectImage4": self._ProjectImage4,
			"ProjectInfo4": self._ProjectInfo4,
			"Project2": self._Project2,
			"ProjectImage2": self._ProjectImage2,
			"ProjectInfo2": self._ProjectInfo2,
			"ProjectFlex1": self._ProjectFlex1,
			"Flex85": self._Flex85,
			"Flex86": self._Flex86,
			"OuterMostFlex7": self._OuterMostFlex7,
			"InnerFlex7": self._InnerFlex7,
			"ContentFlex": self._ContentFlex,
			"LeftFlex": self._LeftFlex,
			"RightFlex": self._RightFlex,
			"ImageFlex": self._ImageFlex,
			"Image3": self._Image3,
			"Image1": self._Image1,
			"Image2": self._Image2,
			"OuterMostFlex6": self._OuterMostFlex6,
			"InnerFlex6": self._InnerFlex6,
			"BlogFlex1": self._BlogFlex1,
			"BlogFlex2": self._BlogFlex2,
			"RightBlogs": self._RightBlogs,
			"Blog5": self._Blog5,
			...
			"LeftBlogs": self._LeftBlogs,
			"OuterMostFlex8": self._OuterMostFlex8,
			"InnerFlex8": self._InnerFlex8,
			"EducationFlex": self._EducationFlex,
			"Institute": self._Institute,
			"Institute3": self._Institute3,
			"Flex169": self._Flex169,
			"Flex170": self._Flex170,
			"Institute2": self._Institute2,
			"Flex171": self._Flex171,
			"Flex172": self._Flex172,
			"Institute1": self._Institute1,
			"Flex173": self._Flex173,
			"Flex174": self._Flex174,
			"Education": self._Education,
			"Flex178": self._Flex178,
			"WorkExperianceFlex": self._WorkExperianceFlex,
			"WorkExperience": self._WorkExperience,
			"Flex159": self._Flex159,
			"Domain": self._Domain,
			"Domain1": self._Domain1,
			"Flex160": self._Flex160,
			"Flex162": self._Flex162,
			"Domain2": self._Domain2,
			"Flex163": self._Flex163,
			"Flex164": self._Flex164,
			"Domain3": self._Domain3,
			"Flex166": self._Flex166,
			"Flex167": self._Flex167,
			"OuterMostFlex9": self._OuterMostFlex9,
			"InnerFlex9": self._InnerFlex9,
			"LeftContent": self._LeftContent,
			"content3": self._content3,
			"Content1": self._Content1,
			"content2": self._content2,
			"RightContent": self._RightContent,
			"InvertedComma": self._InvertedComma,
			"Info": self._Info,
			"Person": self._Person,
			"OuterMostFlex10": self._OuterMostFlex10,
			"InnerFlex10": self._InnerFlex10,
			"FAQFlex": self._FAQFlex,
			"QuestionFlex": self._QuestionFlex,
			"LeftQuestions": self._LeftQuestions,
			"Question1": self._Question1,
			"Question2": self._Question2,
			"Question4": self._Question4,
			"Question3": self._Question3,
			"RightQuestions": self._RightQuestions,
			"Question8": self._Question8,
			"Question7": self._Question7,
			"Question6": self._Question6,
			"Question5": self._Question5,
			"AddressFlex": self._AddressFlex,
			"ContentFlex2": self._ContentFlex2,
			...
			"Column3": self._Column3,
			"FooterFlex": self._FooterFlex,
			"About3": self._About3,
			"About2": self._About2,
			"About4": self._About4,
			"About5": self._About5,
			...
			"BlogNav": self._BlogNav,
			"AboutNav": self._AboutNav,
			"ServiceNav": self._ServiceNav,
			"ProjectNav": self._ProjectNav,
			"BookCallNav": self._BookCallNav,
